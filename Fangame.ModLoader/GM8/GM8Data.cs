...
public class GM8Data
{
    ...
    public readonly GM8Settings Settings;
    public readonly List<GM8Extension> Extensions;
    public readonly List<GM8Trigger?> Triggers;
    public readonly List<GM8Constant> Constants;
    public readonly List<GM8Sound?> Sounds;
    public readonly List<GM8Sprite?> Sprites;
    public readonly List<GM8Background?> Backgrounds;
    public readonly List<GM8Path?> Paths;
    public readonly List<GM8Script?> Scripts;
    public readonly List<GM8Font?> Fonts;
    public readonly List<GM8Timeline?> Timelines;
    public readonly List<GM8Object?> Objects;
    public readonly List<GM8Room?> Rooms;
    public int LastInstanceId;
    public int LastTileId;
    public readonly List<GM8IncludedFile?> IncludedFiles;
    public readonly GM8HelpDialog HelpDialog;
    public readonly List<string> LibraryInitStrings;
    public readonly List<int> RoomOrder;
